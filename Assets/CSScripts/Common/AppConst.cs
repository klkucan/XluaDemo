...
public class AppConst
{
    ...
    public const string AppName = "XluaDemo";           //应用程序名称
    public const string AppPrefix = AppName + "_";             //应用程序前缀
    public const string ExtName = ".assetbundle";              //素材扩展名
    public const string AssetDirname = "Assets/StreamingAssets/";      //素材目录 
    public const string WebUrl = "http://192.168.3.19:6688/";      //测试更新地址
